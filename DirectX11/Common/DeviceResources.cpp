...
void DX::DeviceResources::CreateDeviceResources() 
{
	...
	HRESULT hr = D3D11CreateDevice(
		...
		featureLevels,				// Список уровней компонентов, которые могут поддерживаться этим приложением.
		...
		&m_d3dFeatureLevel,			// Возвращает уровень компонентов созданного устройства.
